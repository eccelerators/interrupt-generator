	...
	begin
		if (Rst = '1') then
			...
			if (WriteDiffControlReg = '1') then
				if (ByteEnable(0) = '1') then WRegControlReg_ChannelOperation0 <= WriteData(0); end if;
				if (ByteEnable(0) = '1') then WRegControlReg_ChannelOperation1 <= WriteData(1); end if;
				if (ByteEnable(0) = '1') then WRegControlReg_ChannelOperation2 <= WriteData(2); end if;
				if (ByteEnable(0) = '1') then WRegControlReg_ChannelOperation3 <= WriteData(3); end if;
			end if;
		end if;
	end process;
