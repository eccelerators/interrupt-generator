...
package InterruptGeneratorIfcPackage is
	...
	type T_InterruptGeneratorIfcAxi4LiteDown is
	record
		AWVALID : std_logic;
		AWADDR : std_logic_vector(6 downto 0);
		...
		BREADY : std_logic;
		ARVALID : std_logic;
		ARADDR : std_logic_vector(6 downto 0);
		ARPROT : std_logic_vector(2 downto 0);
		RREADY : std_logic;
	end record;
	
	type T_InterruptGeneratorIfcAxi4LiteUp is
	record
		AWREADY : std_logic;
		WREADY : std_logic;
		BVALID : std_logic;
	...
	type T_InterruptGeneratorIfcAxi4LiteAccess is
	record
	...
	record
		Axi4LiteDown : T_InterruptGeneratorIfcAxi4LiteDown;
		Axi4LiteUp : T_InterruptGeneratorIfcAxi4LiteUp;
		Axi4LiteAccess : T_InterruptGeneratorIfcAxi4LiteAccess;
	...
	constant INTERRUPTGENERATORBLK_SIZE : std_logic_vector(6 downto 0) := "1011000";
	...
	constant CONTROLREG_CHANNELOPERATION3_POSITION : integer := 3;
	constant CONTROLREG_CHANNELOPERATION3_WIDTH : integer := 1;
	constant CONTROLREG_CHANNELOPERATION3_MASK : std_logic_vector(31 downto 0) := x"00000008";
	constant CONTROLREG_CHANNELOPERATION3_DISABLED : std_logic := '0';
	constant CONTROLREG_CHANNELOPERATION3_ENABLED : std_logic := '1';
	
	constant CONTROLREG_CHANNELOPERATION2_POSITION : integer := 2;
	constant CONTROLREG_CHANNELOPERATION2_WIDTH : integer := 1;
	constant CONTROLREG_CHANNELOPERATION2_MASK : std_logic_vector(31 downto 0) := x"00000004";
	constant CONTROLREG_CHANNELOPERATION2_DISABLED : std_logic := '0';
	constant CONTROLREG_CHANNELOPERATION2_ENABLED : std_logic := '1';
	
	constant CONTROLREG_CHANNELOPERATION1_POSITION : integer := 1;
	constant CONTROLREG_CHANNELOPERATION1_WIDTH : integer := 1;
	constant CONTROLREG_CHANNELOPERATION1_MASK : std_logic_vector(31 downto 0) := x"00000002";
	constant CONTROLREG_CHANNELOPERATION1_DISABLED : std_logic := '0';
	constant CONTROLREG_CHANNELOPERATION1_ENABLED : std_logic := '1';
	
	constant CONTROLREG_CHANNELOPERATION0_POSITION : integer := 0;
	constant CONTROLREG_CHANNELOPERATION0_WIDTH : integer := 1;
	constant CONTROLREG_CHANNELOPERATION0_MASK : std_logic_vector(31 downto 0) := x"00000001";
	constant CONTROLREG_CHANNELOPERATION0_DISABLED : std_logic := '0';
	constant CONTROLREG_CHANNELOPERATION0_ENABLED : std_logic := '1';
	
	constant STATUSREG_WIDTH : integer := 32;
	constant STATUSREG_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0000100" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	
	constant STATUSREG_CHANNELSTATUS3_POSITION : integer := 6;
	constant STATUSREG_CHANNELSTATUS3_WIDTH : integer := 2;
	constant STATUSREG_CHANNELSTATUS3_MASK : std_logic_vector(31 downto 0) := x"000000C0";
	...
	constant STATUSREG_CHANNELSTATUS2_POSITION : integer := 4;
	constant STATUSREG_CHANNELSTATUS2_WIDTH : integer := 2;
	constant STATUSREG_CHANNELSTATUS2_MASK : std_logic_vector(31 downto 0) := x"00000030";
	...
	constant STATUSREG_CHANNELSTATUS1_POSITION : integer := 2;
	constant STATUSREG_CHANNELSTATUS1_WIDTH : integer := 2;
	constant STATUSREG_CHANNELSTATUS1_MASK : std_logic_vector(31 downto 0) := x"0000000C";
	...
	constant STATUSREG_CHANNELSTATUS0_POSITION : integer := 0;
	constant STATUSREG_CHANNELSTATUS0_WIDTH : integer := 2;
	constant STATUSREG_CHANNELSTATUS0_MASK : std_logic_vector(31 downto 0) := x"00000003";
	...
	constant CHARGEDCOUNTREG0_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0001000" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant CHARGEDCOUNTREG1_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0001100" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant CHARGEDCOUNTREG2_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0010000" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant CHARGEDCOUNTREG3_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0010100" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant ACTUALCOUNTREG0_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0011000" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant ACTUALCOUNTREG1_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0011100" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant ACTUALCOUNTREG2_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0100000" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant ACTUALCOUNTREG3_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0100100" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant FAILURECOUNTREG0_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0101000" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant FAILURECOUNTREG1_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0101100" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant FAILURECOUNTREG2_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0110000" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant FAILURECOUNTREG3_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0110100" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant INTERVALREG0_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0111000" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant INTERVALREG1_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("0111100" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant INTERVALREG2_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("1000000" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant INTERVALREG3_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("1000100" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant REFERENCECOUNTREG0_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("1001000" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant REFERENCECOUNTREG1_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("1001100" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant REFERENCECOUNTREG2_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("1010000" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
	...
	constant REFERENCECOUNTREG3_ADDRESS : std_logic_vector(6 downto 0) := std_logic_vector("1010100" + unsigned(INTERRUPTGENERATORBLK_BASE_ADDRESS));
